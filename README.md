...
logsForTickets= Channel where logs of closed tickets will be sent
...
logsForUser= Channel to which logs of exit from the server, ban or deletion of a user's message are sent
